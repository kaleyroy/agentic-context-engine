...
def load_benchmark_data(
    ...
    # Write rawdata to file for debugging
    with open(f"{args.benchmark}-rawdata.json", "w", encoding="utf-8") as f:
        print(f"Writing raw data to {args.benchmark}-rawdata.json")
